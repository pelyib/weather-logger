...
func (owh owHistorical) GetMeasurement(sr business.SearchRequest) []shared.MeasurementResult {
  ...
  if (err != nil) {
    ...
    return []shared.MeasurementResult{}
  }
...
func (owf owForecast) GetMeasurement(sr business.SearchRequest) []shared.MeasurementResult {
  ...
  mrs := make([]shared.MeasurementResult, 0)
...
func MakeOW(cnf *shared.LoggerCnf) business.MeasurementResultProvider {
  return owForecast{cnf: cnf}
}

func MakeOpenWeatherHistoricalProvider( cnf *shared.LoggerCnf) business.MeasurementResultProvider {
  return owHistorical{cnf: cnf}
}
